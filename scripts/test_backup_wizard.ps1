...
$moduleRoot = Join-Path $fixtureRoot 'DoubleSlash/Client'
...
& (Join-Path $QtDir 'bin/qmltestrunner.exe') -input (Join-Path $repoRoot 'rust/doubleslash-client/tests/qml/tst_BackupWizard.qml') -import $fixtureRoot -o "$results,txt"
