...
int doubleslash_enc_set_bitrate(OpusEncoder *enc, opus_int32 value) {
    return opus_encoder_ctl(enc, OPUS_SET_BITRATE_REQUEST, value);
}

int doubleslash_enc_set_vbr(OpusEncoder *enc, opus_int32 value) {
    return opus_encoder_ctl(enc, OPUS_SET_VBR_REQUEST, value);
}

int doubleslash_enc_set_inband_fec(OpusEncoder *enc, opus_int32 value) {
    return opus_encoder_ctl(enc, OPUS_SET_INBAND_FEC_REQUEST, value);
}

int doubleslash_enc_set_packet_loss_perc(OpusEncoder *enc, opus_int32 value) {
    return opus_encoder_ctl(enc, OPUS_SET_PACKET_LOSS_PERC_REQUEST, value);
}

int doubleslash_enc_set_dtx(OpusEncoder *enc, opus_int32 value) {
    return opus_encoder_ctl(enc, OPUS_SET_DTX_REQUEST, value);
}

int doubleslash_enc_set_complexity(OpusEncoder *enc, opus_int32 value) {
...
int doubleslash_enc_set_dred_duration(OpusEncoder *enc, opus_int32 frames_10ms) {
...
int doubleslash_enc_set_dnn_blob(OpusEncoder *enc, const void *data, opus_int32 len) {
    return opus_encoder_ctl(enc, OPUS_SET_DNN_BLOB_REQUEST, data, len);
}

int doubleslash_enc_reset_state(OpusEncoder *enc) {
...
int doubleslash_dec_set_gain(OpusDecoder *dec, opus_int32 value) {
    return opus_decoder_ctl(dec, OPUS_SET_GAIN_REQUEST, value);
}

int doubleslash_dec_set_dnn_blob(OpusDecoder *dec, const void *data, opus_int32 len) {
...
int doubleslash_dec_set_osce_bwe(OpusDecoder *dec, opus_int32 value) {
    return opus_decoder_ctl(dec, OPUS_SET_OSCE_BWE_REQUEST, value);
}

int doubleslash_dec_reset_state(OpusDecoder *dec) {
