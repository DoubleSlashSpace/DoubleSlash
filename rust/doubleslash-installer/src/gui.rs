...
const LOGO_BYTES: &[u8] = include_bytes!("../../doubleslash-client/qml/icons/logo-full.svg");
...
struct AppState {
    ...
    /// Running exe differs from `%LOCALAPPDATA%\DoubleSlash\doubleslash-installer.exe`.
