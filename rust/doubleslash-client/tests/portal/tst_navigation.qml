...
Item {
    ...
    TestCase {
        ...
        function test_load_data() {
            return [
                { tag: "start", initial: true, url: "d://grd123/", expected: "doubleslash://grd123/" },
                { tag: "navigate", initial: false, url: "d://grd123/access.html", expected: "doubleslash://grd123/access.html" },
                { tag: "uppercase", initial: false, url: "D://grd123/games/?mode=test#play", expected: "doubleslash://grd123/games/?mode=test#play" },
                { tag: "legacy", initial: true, url: "doubleslash://grd123/", expected: "doubleslash://grd123/" }
            ]
        }
        ...
        function test_relativeNavigation() {
            var portal = createTemporaryObject(portalComponent, parent,
                { startUrl: "d://grd123/" })
            tryCompare(portal, "pageTitle", "doubleslash://grd123/", 10000)
            // The fixture's only link is at the page's default top-left margin.
            mouseClick(portal, 25, 15)
            tryCompare(portal, "pageTitle", "doubleslash://grd123/games/demo/?mode=test#play", 10000)
        }
