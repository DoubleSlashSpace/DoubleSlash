...
```powershell
cmake -S rust/doubleslash-client/tests/portal -B .tmp-run/portal-build -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH=C:/Qt/6.8.3/msvc2022_64
...
to `file:///D://`. Desktop navigation uses `doubleslash://` internally to avoid that
